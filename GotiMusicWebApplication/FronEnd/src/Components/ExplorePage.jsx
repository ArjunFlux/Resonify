...
function ExplorePage() {
  ...
  const [SongForHollywood , setSongForHollywood] = useState([]);
  useEffect(() => {
  ...
  useEffect(()=>{
    const fetchHollywoodSong = async ()=>{
      try{
        const res = await fetch("https://resonify-2.onrender.com/api/hollywood");
        const songs = await res.json();
  ...
  return (
    <div className="bg-linear-110 from-black to-slate-900 h-screen text-white">
      ...
      <div>
        ...
        <div className="absolute mt-5 ml-80 text-white">
          <div className="flex justify-between items-center gap-15">
            <Link
              to="/playlist"
              state={{
                name: "PlayList 1",
                songs: SongForHollywood.slice(1, 10),
                // ArtistName : SongForPlaylist.results[2].artists.all[0].name,
                PlaylistType: "Favaroite",
              }}
            >
            ...
            <Link
              ...
              state={{
                name: "PlayList 2",
                songs: SongForHollywood.slice(11, 20),
                PlaylistType: "Favaroite",
              }}
            >
              <div className="mt-5 p-5 bg-linear-140 from-blue-500 to-violet-800 rounded-2xl cursor-pointer">
            ...
            <Link
              ...
              state={{
                name: "PlayList 3",
                songs: SongForHollywood.slice(20, 30),
                PlaylistType: "Favaroite",
              }}
            >
              <div className="mt-5 p-5 bg-linear-160 from-slate-700 to-blue-800 rounded-2xl cursor-pointer">
            ...
            <Link
              ...
              state={{
                name: "PlayList 4",
                songs: SongForHollywood.slice(30, 39),
                PlaylistType: "Favaroite",
              }}
            >
              <div className="mt-5 p-5 bg-linear-160 from-green-700 to-cyan-500 rounded-2xl cursor-pointer">
